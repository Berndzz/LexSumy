...
from power_methods import stationary_distribution
...
class LexRank:
    ...
    def get_summary(
        ...
        # sorted_ix = np.argsort(lex_scores)[-summary_size:]
        # sum_index = sorted(sorted_ix)
        # summary = [sentences[i] for i in sum_index[:summary_size]]
